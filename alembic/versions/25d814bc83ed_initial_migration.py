...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('role', sa.Enum('ANONYMOUS', 'AUTHENTICATED', 'MANAGER', 'ADMIN', 'PROFESSIONAL', name='UserRole'), nullable=False),  # Added PROFESSIONAL to Enum
        sa.Column('is_professional', sa.Boolean(), nullable=True),  # Added is_professional field
